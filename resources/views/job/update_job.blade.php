...
<html lang="en">
  ...
  <body id="top">
    ...
    <button type="submit" class="btn btn-primary border-width-2 d-none d-lg-inline-block">
      ...
      <!-- MAIN CONTENT -->
      <div class="container d-flex justify-content-center align-items-center" style="height: 240vh;">
        ...
        <div class="col-12 grid-margin stretch-card">
          ...
          @endif
                      ...
                      <div class="form-group">
                        ...
                        <img height="50" width="50" src="{{ asset('jobimage/' . $job->image) }}" alt="Job Image">
                       </div>
