...
@endif
    ...
    <section class="site-section" style="background-color: white; height: 80vh;" id="home-section">
            <div class="container">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('store_cv') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <button type="submit" class="btn btn-primary text-black">Upload CV</button>
                    </form>
                </div>
            </div>
        </div>
