...
@endif
    ...
    <section class="site-section justify-content-center align-items-center" style="background-color: white; height: 80vh;" id="home-section">
...
<div class="container">
    ...
    <div class="mt-3 d-flex justify-content-center gap-2">
        <a href="{{ asset('storage/' . $cvUser->cv_path) }}" class="btn btn-primary text-black" target="_blank">View CV</a>

        <form action="{{ route('cv.delete', $cvUser->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this CV?');">
            @csrf
            @method('DELETE')
            <button type="submit" class="btn btn-danger text-black">Delete CV</button>
        </form>
    </div>
@else
    <p class="mt-3 text-muted">No CV uploaded yet.</p>
@endif
